...
class IdempotencyMiddleware:
    ...
    async def _serve_cached_response(self, send: Send, idem_key_str: str, cached: any) -> bool:
    ...
    async def _cache_response(self, cache_key: str, res_status: int, res_headers: list, res_body: bytearray):
