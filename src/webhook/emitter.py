...
def _is_rule_matched(hook, module: str, operation: str, resource: str, target: str, trigger: WebhookTrigger) -> bool:
...
def _build_payload(config, module: str, operation: str, resource: str, target: str, action: str, details: Dict[str, Any], trigger: WebhookTrigger) -> WebhookPayload:
...
def emit_event(
    ...
    # Pack and distribute
    payload = _build_payload(config, module, operation, resource, target, action, details, trigger)
